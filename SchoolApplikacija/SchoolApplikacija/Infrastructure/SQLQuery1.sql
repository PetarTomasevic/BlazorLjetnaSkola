...
CREATE TABLE [Instructor] (
    ...
    CONSTRAINT [FK_Instructor_Person_ID] FOREIGN KEY ([ID]) REFERENCES [Person] ([ID]) ON DELETE NO ACTION
);
GO
...
CREATE TABLE [Student] (
    ...
    CONSTRAINT [FK_Student_Person_ID] FOREIGN KEY ([ID]) REFERENCES [Person] ([ID]) ON DELETE NO ACTION
);
GO
